...
const selectVariants = cva('w-full rounded-full px-3 text-sm cursor-pointer disabled:not-allowed', {
  variants: {
    size: {
...
export function TrackDeviceSelect({
  ...
  return (
    ...
    >
      <SelectTrigger className={cn(selectVariants({ size }), '!h-11', props.className)}>
        {size !== 'sm' && (
