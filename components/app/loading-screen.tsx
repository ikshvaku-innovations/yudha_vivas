...
const tips = [
  'Get ready for your AI evaluation!',
  'Your AI Evaluator is here to assess your proficiency.',
  'Feel free to clarify the questions anytime during the session.',
...
export const LoadingScreen = ({
  className,
  title = 'Waiting for your AI Evaluator to join...',
  description,
}: LoadingScreenProps) => {
